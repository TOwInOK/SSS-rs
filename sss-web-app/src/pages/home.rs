                    ...
                    <div class="space-y-6">
                        ...
                        <Stack title="Links">
                            <div class="flex gap-4 flex-wrap">
                                <IconLink href="https://github.com/TOwInOK/SSS-rs" text="Project" />
                                <IconLink href="https://github.com/TOwInOK" text="Author" />
                            </div>
                        </Stack>
                            ...
                            <div class="grid gap-4">
                                <StepCard
                                    ...
                                    action=view! {
                                        <a
                                            href="editor"
                                            class="p-2 mt-2 rounded-lg border bg-opacity-10 flex transform hover:scale-102 transition-all duration-600"
                                        >
                                            Go to Editor
                                        </a>
                                    }
...
fn IconLink(
    ...
    view! {
        <a
            href=href
            class="flex items-center gap-2 px-4 py-2 rounded-lg border transform hover:scale-102 transition-all duration-600"
        >
            <span>{text}</span>
        </a>
    }
